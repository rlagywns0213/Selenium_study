...
def capture_replys(keyword, url, excel_name=None):
    ...
    if excel_name:
        ...
        data_frame.to_excel('{}.xlsx'.format(excel_name), sheet_name = '수집시트명', startrow = 0 , header = True)
...
if __name__ == '__main__':
    capture_replys('코로나','pe=popular_day&oid=001&aid=0011456854&date=20200308&type=1&rankingSeq=9&rankingSectionId=104&m_view=1&includeAllCount=true&m_url=%2Fcomment%2Fall.nhn%3FserviceId%3Dnews%26gno%3Dnews001%2C0011456854%26sort%3Dlikability')
    #엑셀 이름 안 넣으면 엑셀 만들지 않음